  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 flex-col justify-between">
        ...
        <div>
          <h1 className="text-4xl font-bold text-primary-foreground mb-4">Start Your Journey</h1>
          <p className="text-primary-foreground/80 text-lg">
            Create an account and take control of your tasks. Stay organized, stay productive.
          </p>
        </div>
        <p className="text-primary-foreground/60 text-sm">© 2025 TaskFlow. All rights reserved.</p>
      </div>
